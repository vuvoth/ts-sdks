...
export function init(packageAddress: string) {
	 ...
	 */
	function reserve_space_for_epochs(options: {
		arguments: [
			self: RawTransactionArgument<string>,
			storage_amount: RawTransactionArgument<number | bigint>,
			start_epoch: RawTransactionArgument<number>,
			end_epoch: RawTransactionArgument<number>,
			payment: RawTransactionArgument<string>,
		];
	}) {
		const argumentsTypes = [
	 ...
	 */
	function add_per_epoch_subsidies(options: {
		arguments: [
			system: RawTransactionArgument<string>,
	...
	function future_accounting(options: { arguments: [self: RawTransactionArgument<string>] }) {
		const argumentsTypes = [`${packageAddress}::system::System`] satisfies string[];
		return (tx: Transaction) =>
			tx.moveCall({
				package: packageAddress,
