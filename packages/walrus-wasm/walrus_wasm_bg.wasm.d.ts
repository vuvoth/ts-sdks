...
export const blobencoder_encode_with_metadata: (a: number, b: number, c: number, d: number) => [number, number, number];
export const blobencoder_compute_metadata: (a: number, b: number, c: number, d: number) => [number, number, number];
export const blobencoder_decode_primary: (a: number, b: any, c: bigint, d: any, e: number) => [number, number, number];
