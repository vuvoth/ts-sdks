 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.CheckpointSummary
 */
export interface CheckpointSummary {
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.GasCostSummary epoch_rolling_gas_cost_summary = 8;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.CheckpointCommitment commitments = 10;
	 */
	commitments: CheckpointCommitment[];
	/**
	 * Extra data only present in the final checkpoint of an epoch.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.EndOfEpochData end_of_epoch_data = 11;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.EndOfEpochData
 */
export interface EndOfEpochData {
	/**
	 * The set of validators that will be in the `ValidatorCommittee` for the next epoch.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.ValidatorCommitteeMember next_epoch_committee = 1;
	 */
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.CheckpointCommitment epoch_commitments = 3;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.CheckpointCommitment
 */
export interface CheckpointCommitment {
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.CheckpointCommitment.CheckpointCommitmentKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum sui.rpc.v2beta.CheckpointCommitment.CheckpointCommitmentKind
 */
...
class CheckpointSummary$Type extends MessageType<CheckpointSummary> {
	constructor() {
		super('sui.rpc.v2beta.CheckpointSummary', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional string previous_digest */ 7:
					...
					break;
				case /* optional sui.rpc.v2beta.GasCostSummary epoch_rolling_gas_cost_summary */ 8:
				...
				case /* optional google.protobuf.Timestamp timestamp */ 9:
					...
					break;
				case /* repeated sui.rpc.v2beta.CheckpointCommitment commitments */ 10:
					message.commitments.push(
						CheckpointCommitment.internalBinaryRead(reader, reader.uint32(), options),
					);
					break;
				case /* optional sui.rpc.v2beta.EndOfEpochData end_of_epoch_data */ 11:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.GasCostSummary epoch_rolling_gas_cost_summary = 8; */
		...
		/* repeated sui.rpc.v2beta.CheckpointCommitment commitments = 10; */
		...
		/* optional sui.rpc.v2beta.EndOfEpochData end_of_epoch_data = 11; */
...
class EndOfEpochData$Type extends MessageType<EndOfEpochData> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.ValidatorCommitteeMember next_epoch_committee */ 1:
				...
				case /* optional uint64 next_epoch_protocol_version */ 2:
					...
					break;
				case /* repeated sui.rpc.v2beta.CheckpointCommitment epoch_commitments */ 3:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.ValidatorCommitteeMember next_epoch_committee = 1; */
		...
		/* repeated sui.rpc.v2beta.CheckpointCommitment epoch_commitments = 3; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.EndOfEpochData
 */
...
class CheckpointCommitment$Type extends MessageType<CheckpointCommitment> {
	constructor() {
		super('sui.rpc.v2beta.CheckpointCommitment', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'sui.rpc.v2beta.CheckpointCommitment.CheckpointCommitmentKind',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.CheckpointCommitment.CheckpointCommitmentKind kind */ 1:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.CheckpointCommitment.CheckpointCommitmentKind kind = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.CheckpointCommitment
 */
