 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.TransactionEvents
 */
export interface TransactionEvents {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Event events = 3;
	 */
	events: Event[];
}
/**
 * An event.
 *
 * @generated from protobuf message sui.rpc.v2beta.Event
 */
export interface Event {
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Bcs contents = 5;
	 */
	contents?: Bcs;
}
...
class TransactionEvents$Type extends MessageType<TransactionEvents> {
	constructor() {
		super('sui.rpc.v2beta.TransactionEvents', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional string digest */ 2:
					...
					break;
				case /* repeated sui.rpc.v2beta.Event events */ 3:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Event events = 3; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.TransactionEvents
 */
export const TransactionEvents = new TransactionEvents$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Event$Type extends MessageType<Event> {
	constructor() {
		super('sui.rpc.v2beta.Event', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional string event_type */ 4:
					...
					break;
				case /* optional sui.rpc.v2beta.Bcs contents */ 5:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.Bcs contents = 5; */
		if (message.contents)
			Bcs.internalBinaryWrite(
				message.contents,
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Event
 */
