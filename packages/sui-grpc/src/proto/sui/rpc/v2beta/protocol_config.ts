...
/**
 * @generated from protobuf message sui.rpc.v2beta.ProtocolConfig
 */
...
class ProtocolConfig$Type extends MessageType<ProtocolConfig> {
	constructor() {
		super('sui.rpc.v2beta.ProtocolConfig', [
			{
				no: 1,
	...
	private binaryReadMap2(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				default:
					throw new globalThis.Error(
						'unknown map entry field for field sui.rpc.v2beta.ProtocolConfig.feature_flags',
					);
			}
		}
		map[key ?? ''] = val ?? false;
	...
	private binaryReadMap3(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				default:
					throw new globalThis.Error(
						'unknown map entry field for field sui.rpc.v2beta.ProtocolConfig.attributes',
					);
			}
		}
		map[key ?? ''] = val ?? '';
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ProtocolConfig
 */
