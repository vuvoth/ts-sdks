 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.GasCostSummary
 */
...
class GasCostSummary$Type extends MessageType<GasCostSummary> {
	constructor() {
		super('sui.rpc.v2beta.GasCostSummary', [
			{
				no: 1,
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.GasCostSummary
 */
