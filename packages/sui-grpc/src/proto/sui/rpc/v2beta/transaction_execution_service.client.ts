...
/**
 * @generated from protobuf service sui.rpc.v2beta.TransactionExecutionService
 */
export interface ITransactionExecutionServiceClient {
	/**
	 * @generated from protobuf rpc: ExecuteTransaction(sui.rpc.v2beta.ExecuteTransactionRequest) returns (sui.rpc.v2beta.ExecuteTransactionResponse);
	 */
	executeTransaction(
