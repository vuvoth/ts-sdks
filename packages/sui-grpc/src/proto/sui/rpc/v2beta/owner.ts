 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.Owner
 */
export interface Owner {
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.Owner.OwnerKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum sui.rpc.v2beta.Owner.OwnerKind
 */
...
class Owner$Type extends MessageType<Owner> {
	constructor() {
		super('sui.rpc.v2beta.Owner', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => ['sui.rpc.v2beta.Owner.OwnerKind', Owner_OwnerKind],
			},
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.Owner.OwnerKind kind */ 1:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.Owner.OwnerKind kind = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Owner
 */
