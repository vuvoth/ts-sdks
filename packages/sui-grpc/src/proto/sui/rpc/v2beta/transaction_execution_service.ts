...
/**
 * @generated from protobuf message sui.rpc.v2beta.ExecuteTransactionRequest
 */
export interface ExecuteTransactionRequest {
	 ...
	 * transaction.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.UserSignature signatures = 2;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ExecuteTransactionResponse
 */
export interface ExecuteTransactionResponse {
	/**
	 * Indicates the finality of the executed transaction.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionFinality finality = 1;
	 */
	finality?: TransactionFinality;
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.ExecutedTransaction transaction = 2;
	 */
 ...
 * Indicates the finality of the executed transaction.
 *
 * @generated from protobuf message sui.rpc.v2beta.TransactionFinality
 */
export interface TransactionFinality {
	...
	finality:
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ValidatorAggregatedSignature certified = 1;
				 */
...
class ExecuteTransactionRequest$Type extends MessageType<ExecuteTransactionRequest> {
	constructor() {
		super('sui.rpc.v2beta.ExecuteTransactionRequest', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.Transaction transaction */ 1:
					...
					break;
				case /* repeated sui.rpc.v2beta.UserSignature signatures */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.UserSignature signatures = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ExecuteTransactionRequest
 */
...
class ExecuteTransactionResponse$Type extends MessageType<ExecuteTransactionResponse> {
	constructor() {
		super('sui.rpc.v2beta.ExecuteTransactionResponse', [
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.TransactionFinality finality */ 1:
					...
					break;
				case /* optional sui.rpc.v2beta.ExecutedTransaction transaction */ 2:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.TransactionFinality finality = 1; */
		if (message.finality)
		...
		/* optional sui.rpc.v2beta.ExecutedTransaction transaction = 2; */
		if (message.transaction)
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ExecuteTransactionResponse
 */
...
class TransactionFinality$Type extends MessageType<TransactionFinality> {
	constructor() {
		super('sui.rpc.v2beta.TransactionFinality', [
			{
				no: 1,
				name: 'certified',
				kind: 'message',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* sui.rpc.v2beta.ValidatorAggregatedSignature certified */ 1:
					message.finality = {
						oneofKind: 'certified',
	...
	internalBinaryWrite(
		...
		/* sui.rpc.v2beta.ValidatorAggregatedSignature certified = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.TransactionFinality
 */
export const TransactionFinality = new TransactionFinality$Type();
/**
 * @generated ServiceType for protobuf service sui.rpc.v2beta.TransactionExecutionService
 */
