 ...
 * A transaction.
 *
 * @generated from protobuf message sui.rpc.v2beta.Transaction
 */
export interface Transaction {
	...
	version?: number;
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionKind kind = 4;
	 */
	...
	sender?: string;
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.GasPayment gas_payment = 6;
	 */
	gasPayment?: GasPayment;
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionExpiration expiration = 7;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.GasPayment
 */
export interface GasPayment {
	/**
	 * Set of gas objects to use for payment.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.ObjectReference objects = 1;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.TransactionExpiration
 */
export interface TransactionExpiration {
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionExpiration.TransactionExpirationKind kind = 1;
	 */
...
/**
 * @generated from protobuf enum sui.rpc.v2beta.TransactionExpiration.TransactionExpirationKind
 */
 ...
 * Transaction type.
 *
 * @generated from protobuf message sui.rpc.v2beta.TransactionKind
 */
export interface TransactionKind {
	...
	kind:
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ProgrammableTransaction programmable_transaction = 2;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ChangeEpoch change_epoch = 100;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.GenesisTransaction genesis = 101;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v1 = 102;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.AuthenticatorStateUpdate authenticator_state_update = 103;
				 */
		...
		| {
				 ...
				 * the next one.
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.EndOfEpochTransaction end_of_epoch = 104;
				 */
		...
		| {
				 ...
				 * Randomness update.
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.RandomnessStateUpdate randomness_state_update = 105;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v2 = 106;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v3 = 107;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v4 = 108;
				 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ProgrammableTransaction
 */
export interface ProgrammableTransaction {
	/**
	 * Input objects or primitive values.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Input inputs = 1;
	 */
	inputs: Input[];
	/**
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Command commands = 2;
	 */
	commands: Command[];
}
/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.Command
 */
export interface Command {
	...
	command:
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.MoveCall move_call = 1;
				 */
				moveCall: MoveCall;
		  }
		| {
				 ...
				 * be newly created.
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.TransferObjects transfer_objects = 2;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.SplitCoins split_coins = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.MergeCoins merge_coins = 4;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.Publish publish = 5;
				 */
				publish: Publish;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.MakeMoveVector make_move_vector = 6;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.Upgrade upgrade = 7;
				 */
				upgrade: Upgrade;
		  }
		| {
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.MoveCall
 */
export interface MoveCall {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Argument arguments = 5;
	 */
	arguments: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.TransferObjects
 */
export interface TransferObjects {
	/**
	 * Set of objects to transfer.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Argument objects = 1;
	 */
	objects: Argument[];
	/**
	 * The address to transfer ownership to.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Argument address = 2;
	 */
	address?: Argument;
}
/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.SplitCoins
 */
export interface SplitCoins {
	/**
	 * The coin to split.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Argument coin = 1;
	 */
	coin?: Argument;
	/**
	 * The amounts to split off.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Argument amounts = 2;
	 */
	amounts: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.MergeCoins
 */
export interface MergeCoins {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Argument coins_to_merge = 2;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.Publish
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.MakeMoveVector
 */
export interface MakeMoveVector {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Argument elements = 2;
	 */
	elements: Argument[];
}
/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.Upgrade
 */
export interface Upgrade {
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Argument ticket = 4;
	 */
	ticket?: Argument;
}
/**
 * Randomness update.
 *
 * @generated from protobuf message sui.rpc.v2beta.RandomnessStateUpdate
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ChangeEpoch
 */
export interface ChangeEpoch {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.SystemPackage system_packages = 8;
	 */
 ...
 * System package.
 *
 * @generated from protobuf message sui.rpc.v2beta.SystemPackage
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.GenesisTransaction
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ConsensusCommitPrologue
 */
export interface ConsensusCommitPrologue {
	 ...
	 * Present in V3, V4.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.ConsensusDeterminedVersionAssignments consensus_determined_version_assignments = 6;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.VersionAssignment
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.CanceledTransaction
 */
export interface CanceledTransaction {
	 ...
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.VersionAssignment version_assignments = 2;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.CanceledTransactions
 */
export interface CanceledTransactions {
	/**
	 * @generated from protobuf field: repeated sui.rpc.v2beta.CanceledTransaction canceled_transactions = 1;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ConsensusDeterminedVersionAssignments
 */
export interface ConsensusDeterminedVersionAssignments {
	...
	kind:
		| {
				oneofKind: 'canceledTransactions';
				/**
				 * Canceled transaction version assignment.
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.CanceledTransactions canceled_transactions = 2;
				 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.AuthenticatorStateUpdate
 */
export interface AuthenticatorStateUpdate {
	 ...
	 * Newly active JWKs.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.ActiveJwk new_active_jwks = 3;
	 */
 ...
 * A new JWK.
 *
 * @generated from protobuf message sui.rpc.v2beta.ActiveJwk
 */
export interface ActiveJwk {
	/**
	 * Identifier used to uniquely identify a JWK.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.JwkId id = 1;
	 */
	id?: JwkId;
	/**
	 * The JWK.
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Jwk jwk = 2;
	 */
	jwk?: Jwk;
	/**
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.JwkId
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.Jwk
 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.EndOfEpochTransaction
 */
export interface EndOfEpochTransaction {
	/**
	 * @generated from protobuf field: repeated sui.rpc.v2beta.EndOfEpochTransactionKind transactions = 1;
	 */
 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.EndOfEpochTransactionKind
 */
export interface EndOfEpochTransactionKind {
	...
	kind:
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ChangeEpoch change_epoch = 2;
				 */
				changeEpoch: ChangeEpoch;
		  }
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.AuthenticatorStateExpire authenticator_state_expire = 3;
				 */
		...
		| {
				 ...
				 *
				 * @generated from protobuf field: sui.rpc.v2beta.ExecutionTimeObservations execution_time_observations = 4;
				 */
 ...
 * Expire old JWKs.
 *
 * @generated from protobuf message sui.rpc.v2beta.AuthenticatorStateExpire
 */
...
/**
 * @generated from protobuf message sui.rpc.v2beta.ExecutionTimeObservations
 */
export interface ExecutionTimeObservations {
	...
	version?: number;
	/**
	 * @generated from protobuf field: repeated sui.rpc.v2beta.ExecutionTimeObservation observations = 2;
	 */
	observations: ExecutionTimeObservation[];
}
/**
 * @generated from protobuf message sui.rpc.v2beta.ExecutionTimeObservation
 */
export interface ExecutionTimeObservation {
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.ExecutionTimeObservation.ExecutionTimeObservationKind kind = 1;
	 */
	kind?: ExecutionTimeObservation_ExecutionTimeObservationKind;
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.MoveCall move_entry_point = 2;
	 */
	moveEntryPoint?: MoveCall;
	/**
	 * @generated from protobuf field: repeated sui.rpc.v2beta.ValidatorExecutionTimeObservation validator_observations = 3;
	 */
	validatorObservations: ValidatorExecutionTimeObservation[];
}
/**
 * @generated from protobuf enum sui.rpc.v2beta.ExecutionTimeObservation.ExecutionTimeObservationKind
 */
...
/**
 * @generated from protobuf message sui.rpc.v2beta.ValidatorExecutionTimeObservation
 */
...
class Transaction$Type extends MessageType<Transaction> {
	constructor() {
		super('sui.rpc.v2beta.Transaction', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional int32 version */ 3:
					...
					break;
				case /* optional sui.rpc.v2beta.TransactionKind kind */ 4:
				...
				case /* optional string sender */ 5:
					...
					break;
				case /* optional sui.rpc.v2beta.GasPayment gas_payment */ 6:
					...
					break;
				case /* optional sui.rpc.v2beta.TransactionExpiration expiration */ 7:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.TransactionKind kind = 4; */
		if (message.kind)
		...
		/* optional sui.rpc.v2beta.GasPayment gas_payment = 6; */
		...
		/* optional sui.rpc.v2beta.TransactionExpiration expiration = 7; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Transaction
 */
export const Transaction = new Transaction$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GasPayment$Type extends MessageType<GasPayment> {
	constructor() {
		super('sui.rpc.v2beta.GasPayment', [
			{
				no: 1,
				name: 'objects',
				kind: 'message',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.ObjectReference objects */ 1:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.ObjectReference objects = 1; */
...
class TransactionExpiration$Type extends MessageType<TransactionExpiration> {
		...
		super('sui.rpc.v2beta.TransactionExpiration', [
			{
				...
				opt: true,
				T: () => [
					'sui.rpc.v2beta.TransactionExpiration.TransactionExpirationKind',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.TransactionExpiration.TransactionExpirationKind kind */ 1:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.TransactionExpiration.TransactionExpirationKind kind = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.TransactionExpiration
 */
...
class TransactionKind$Type extends MessageType<TransactionKind> {
	constructor() {
		super('sui.rpc.v2beta.TransactionKind', [
			{
				no: 2,
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* sui.rpc.v2beta.ProgrammableTransaction programmable_transaction */ 2:
					message.kind = {
						oneofKind: 'programmableTransaction',
					...
					break;
				case /* sui.rpc.v2beta.ChangeEpoch change_epoch */ 100:
					message.kind = {
						oneofKind: 'changeEpoch',
					...
					break;
				case /* sui.rpc.v2beta.GenesisTransaction genesis */ 101:
					message.kind = {
						oneofKind: 'genesis',
					...
					break;
				case /* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v1 */ 102:
					message.kind = {
						oneofKind: 'consensusCommitPrologueV1',
					...
					break;
				case /* sui.rpc.v2beta.AuthenticatorStateUpdate authenticator_state_update */ 103:
					message.kind = {
						oneofKind: 'authenticatorStateUpdate',
					...
					break;
				case /* sui.rpc.v2beta.EndOfEpochTransaction end_of_epoch */ 104:
					message.kind = {
						oneofKind: 'endOfEpoch',
					...
					break;
				case /* sui.rpc.v2beta.RandomnessStateUpdate randomness_state_update */ 105:
					message.kind = {
						oneofKind: 'randomnessStateUpdate',
					...
					break;
				case /* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v2 */ 106:
					message.kind = {
						oneofKind: 'consensusCommitPrologueV2',
					...
					break;
				case /* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v3 */ 107:
					message.kind = {
						oneofKind: 'consensusCommitPrologueV3',
					...
					break;
				case /* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v4 */ 108:
					message.kind = {
						oneofKind: 'consensusCommitPrologueV4',
	...
	internalBinaryWrite(
		...
		/* sui.rpc.v2beta.ProgrammableTransaction programmable_transaction = 2; */
		...
		/* sui.rpc.v2beta.ChangeEpoch change_epoch = 100; */
		...
		/* sui.rpc.v2beta.GenesisTransaction genesis = 101; */
		...
		/* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v1 = 102; */
		...
		/* sui.rpc.v2beta.AuthenticatorStateUpdate authenticator_state_update = 103; */
		...
		/* sui.rpc.v2beta.EndOfEpochTransaction end_of_epoch = 104; */
		...
		/* sui.rpc.v2beta.RandomnessStateUpdate randomness_state_update = 105; */
		...
		/* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v2 = 106; */
		...
		/* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v3 = 107; */
		...
		/* sui.rpc.v2beta.ConsensusCommitPrologue consensus_commit_prologue_v4 = 108; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.TransactionKind
 */
...
class ProgrammableTransaction$Type extends MessageType<ProgrammableTransaction> {
	constructor() {
		super('sui.rpc.v2beta.ProgrammableTransaction', [
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.Input inputs */ 1:
					message.inputs.push(Input.internalBinaryRead(reader, reader.uint32(), options));
					break;
				case /* repeated sui.rpc.v2beta.Command commands */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Input inputs = 1; */
		...
		/* repeated sui.rpc.v2beta.Command commands = 2; */
...
class Command$Type extends MessageType<Command> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* sui.rpc.v2beta.MoveCall move_call */ 1:
					message.command = {
						oneofKind: 'moveCall',
					...
					break;
				case /* sui.rpc.v2beta.TransferObjects transfer_objects */ 2:
					message.command = {
						oneofKind: 'transferObjects',
					...
					break;
				case /* sui.rpc.v2beta.SplitCoins split_coins */ 3:
					message.command = {
						oneofKind: 'splitCoins',
					...
					break;
				case /* sui.rpc.v2beta.MergeCoins merge_coins */ 4:
					message.command = {
						oneofKind: 'mergeCoins',
					...
					break;
				case /* sui.rpc.v2beta.Publish publish */ 5:
					message.command = {
						oneofKind: 'publish',
					...
					break;
				case /* sui.rpc.v2beta.MakeMoveVector make_move_vector */ 6:
					message.command = {
						oneofKind: 'makeMoveVector',
					...
					break;
				case /* sui.rpc.v2beta.Upgrade upgrade */ 7:
					message.command = {
						oneofKind: 'upgrade',
	...
	internalBinaryWrite(
		...
		/* sui.rpc.v2beta.MoveCall move_call = 1; */
		...
		/* sui.rpc.v2beta.TransferObjects transfer_objects = 2; */
		...
		/* sui.rpc.v2beta.SplitCoins split_coins = 3; */
		...
		/* sui.rpc.v2beta.MergeCoins merge_coins = 4; */
		...
		/* sui.rpc.v2beta.Publish publish = 5; */
		...
		/* sui.rpc.v2beta.MakeMoveVector make_move_vector = 6; */
		...
		/* sui.rpc.v2beta.Upgrade upgrade = 7; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Command
 */
export const Command = new Command$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MoveCall$Type extends MessageType<MoveCall> {
	constructor() {
		super('sui.rpc.v2beta.MoveCall', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* repeated string type_arguments */ 4:
					...
					break;
				case /* repeated sui.rpc.v2beta.Argument arguments */ 5:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Argument arguments = 5; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.MoveCall
 */
export const MoveCall = new MoveCall$Type();
// @generated message type with reflection information, may provide speed optimized methods
class TransferObjects$Type extends MessageType<TransferObjects> {
	constructor() {
		super('sui.rpc.v2beta.TransferObjects', [
			{
				no: 1,
				name: 'objects',
				kind: 'message',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.Argument objects */ 1:
					message.objects.push(Argument.internalBinaryRead(reader, reader.uint32(), options));
					break;
				case /* optional sui.rpc.v2beta.Argument address */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Argument objects = 1; */
		for (let i = 0; i < message.objects.length; i++)
			Argument.internalBinaryWrite(
				message.objects[i],
				writer.tag(1, WireType.LengthDelimited).fork(),
		...
		/* optional sui.rpc.v2beta.Argument address = 2; */
		if (message.address)
			Argument.internalBinaryWrite(
				message.address,
				writer.tag(2, WireType.LengthDelimited).fork(),
...
class SplitCoins$Type extends MessageType<SplitCoins> {
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.Argument coin */ 1:
					...
					break;
				case /* repeated sui.rpc.v2beta.Argument amounts */ 2:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.Argument coin = 1; */
		if (message.coin)
			Argument.internalBinaryWrite(
				message.coin,
				writer.tag(1, WireType.LengthDelimited).fork(),
		...
		/* repeated sui.rpc.v2beta.Argument amounts = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.SplitCoins
 */
export const SplitCoins = new SplitCoins$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MergeCoins$Type extends MessageType<MergeCoins> {
	constructor() {
		super('sui.rpc.v2beta.MergeCoins', [
			{ no: 1, name: 'coin', kind: 'message', T: () => Argument },
			{
				no: 2,
				name: 'coins_to_merge',
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.Argument coin */ 1:
					...
					break;
				case /* repeated sui.rpc.v2beta.Argument coins_to_merge */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Argument coins_to_merge = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.MergeCoins
 */
export const MergeCoins = new MergeCoins$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Publish$Type extends MessageType<Publish> {
	constructor() {
		super('sui.rpc.v2beta.Publish', [
			{
				no: 1,
				name: 'modules',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Publish
 */
export const Publish = new Publish$Type();
// @generated message type with reflection information, may provide speed optimized methods
class MakeMoveVector$Type extends MessageType<MakeMoveVector> {
	constructor() {
		super('sui.rpc.v2beta.MakeMoveVector', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional string element_type */ 1:
					...
					break;
				case /* repeated sui.rpc.v2beta.Argument elements */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.Argument elements = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.MakeMoveVector
 */
export const MakeMoveVector = new MakeMoveVector$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Upgrade$Type extends MessageType<Upgrade> {
	constructor() {
		super('sui.rpc.v2beta.Upgrade', [
			{
				no: 1,
				name: 'modules',
				kind: 'scalar',
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional string package */ 3:
					message.package = reader.string();
					break;
				case /* optional sui.rpc.v2beta.Argument ticket */ 4:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.Argument ticket = 4; */
		if (message.ticket)
			Argument.internalBinaryWrite(
				message.ticket,
				writer.tag(4, WireType.LengthDelimited).fork(),
...
class ChangeEpoch$Type extends MessageType<ChangeEpoch> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional google.protobuf.Timestamp epoch_start_timestamp */ 7:
					...
					break;
				case /* repeated sui.rpc.v2beta.SystemPackage system_packages */ 8:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.SystemPackage system_packages = 8; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ChangeEpoch
 */
export const ChangeEpoch = new ChangeEpoch$Type();
// @generated message type with reflection information, may provide speed optimized methods
class SystemPackage$Type extends MessageType<SystemPackage> {
	constructor() {
		super('sui.rpc.v2beta.SystemPackage', [
			{
				no: 1,
				name: 'version',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.GenesisTransaction
 */
...
class ConsensusCommitPrologue$Type extends MessageType<ConsensusCommitPrologue> {
	constructor() {
		super('sui.rpc.v2beta.ConsensusCommitPrologue', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional uint64 sub_dag_index */ 5:
					...
					break;
				case /* optional sui.rpc.v2beta.ConsensusDeterminedVersionAssignments consensus_determined_version_assignments */ 6:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.ConsensusDeterminedVersionAssignments consensus_determined_version_assignments = 6; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ConsensusCommitPrologue
 */
...
class VersionAssignment$Type extends MessageType<VersionAssignment> {
	constructor() {
		super('sui.rpc.v2beta.VersionAssignment', [
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.VersionAssignment
 */
...
class CanceledTransaction$Type extends MessageType<CanceledTransaction> {
	constructor() {
		super('sui.rpc.v2beta.CanceledTransaction', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional string digest */ 1:
					message.digest = reader.string();
					break;
				case /* repeated sui.rpc.v2beta.VersionAssignment version_assignments */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.VersionAssignment version_assignments = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.CanceledTransaction
 */
export const CanceledTransaction = new CanceledTransaction$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CanceledTransactions$Type extends MessageType<CanceledTransactions> {
	constructor() {
		super('sui.rpc.v2beta.CanceledTransactions', [
			{
				no: 1,
	...
	create(value?: PartialMessage<CanceledTransactions>): CanceledTransactions {
		const message = globalThis.Object.create(this.messagePrototype!);
		message.canceledTransactions = [];
		if (value !== undefined) reflectionMergePartial<CanceledTransactions>(this, message, value);
		return message;
	}
	internalBinaryRead(
		reader: IBinaryReader,
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.CanceledTransaction canceled_transactions */ 1:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.CanceledTransaction canceled_transactions = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.CanceledTransactions
 */
export const CanceledTransactions = new CanceledTransactions$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ConsensusDeterminedVersionAssignments$Type extends MessageType<ConsensusDeterminedVersionAssignments> {
	constructor() {
		super('sui.rpc.v2beta.ConsensusDeterminedVersionAssignments', [
			{
				no: 2,
				name: 'canceled_transactions',
				kind: 'message',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* sui.rpc.v2beta.CanceledTransactions canceled_transactions */ 2:
					message.kind = {
						oneofKind: 'canceledTransactions',
						canceledTransactions: CanceledTransactions.internalBinaryRead(
							reader,
							reader.uint32(),
							options,
							(message.kind as any).canceledTransactions,
						),
					};
					break;
				default:
	...
	internalBinaryWrite(
		...
		/* sui.rpc.v2beta.CanceledTransactions canceled_transactions = 2; */
		if (message.kind.oneofKind === 'canceledTransactions')
			CanceledTransactions.internalBinaryWrite(
				message.kind.canceledTransactions,
				writer.tag(2, WireType.LengthDelimited).fork(),
				options,
			).join();
		let u = options.writeUnknownFields;
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ConsensusDeterminedVersionAssignments
 */
...
class AuthenticatorStateUpdate$Type extends MessageType<AuthenticatorStateUpdate> {
	constructor() {
		super('sui.rpc.v2beta.AuthenticatorStateUpdate', [
			{
				no: 1,
				name: 'epoch',
				kind: 'scalar',
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				...
				case /* optional uint64 round */ 2:
					message.round = reader.uint64().toBigInt();
					break;
				case /* repeated sui.rpc.v2beta.ActiveJwk new_active_jwks */ 3:
	...
	internalBinaryWrite(
		...
		/* optional uint64 round = 2; */
		if (message.round !== undefined) writer.tag(2, WireType.Varint).uint64(message.round);
		/* repeated sui.rpc.v2beta.ActiveJwk new_active_jwks = 3; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.AuthenticatorStateUpdate
 */
...
class ActiveJwk$Type extends MessageType<ActiveJwk> {
	constructor() {
		super('sui.rpc.v2beta.ActiveJwk', [
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.JwkId id */ 1:
					message.id = JwkId.internalBinaryRead(reader, reader.uint32(), options, message.id);
					break;
				case /* optional sui.rpc.v2beta.Jwk jwk */ 2:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.JwkId id = 1; */
		if (message.id)
		...
		/* optional sui.rpc.v2beta.Jwk jwk = 2; */
		if (message.jwk)
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ActiveJwk
 */
export const ActiveJwk = new ActiveJwk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class JwkId$Type extends MessageType<JwkId> {
	constructor() {
		super('sui.rpc.v2beta.JwkId', [
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.JwkId
 */
export const JwkId = new JwkId$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Jwk$Type extends MessageType<Jwk> {
	constructor() {
		super('sui.rpc.v2beta.Jwk', [
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Jwk
 */
export const Jwk = new Jwk$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EndOfEpochTransaction$Type extends MessageType<EndOfEpochTransaction> {
	constructor() {
		super('sui.rpc.v2beta.EndOfEpochTransaction', [
			{
				no: 1,
				name: 'transactions',
				kind: 'message',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* repeated sui.rpc.v2beta.EndOfEpochTransactionKind transactions */ 1:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.EndOfEpochTransactionKind transactions = 1; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.EndOfEpochTransaction
 */
...
class EndOfEpochTransactionKind$Type extends MessageType<EndOfEpochTransactionKind> {
	constructor() {
		super('sui.rpc.v2beta.EndOfEpochTransactionKind', [
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* sui.rpc.v2beta.ChangeEpoch change_epoch */ 2:
					message.kind = {
						oneofKind: 'changeEpoch',
						changeEpoch: ChangeEpoch.internalBinaryRead(
							reader,
					...
					break;
				case /* sui.rpc.v2beta.AuthenticatorStateExpire authenticator_state_expire */ 3:
					message.kind = {
						oneofKind: 'authenticatorStateExpire',
					...
					break;
				case /* sui.rpc.v2beta.ExecutionTimeObservations execution_time_observations */ 4:
					message.kind = {
						oneofKind: 'executionTimeObservations',
	...
	internalBinaryWrite(
		...
		/* sui.rpc.v2beta.ChangeEpoch change_epoch = 2; */
		if (message.kind.oneofKind === 'changeEpoch')
			ChangeEpoch.internalBinaryWrite(
				message.kind.changeEpoch,
				writer.tag(2, WireType.LengthDelimited).fork(),
		...
		/* sui.rpc.v2beta.AuthenticatorStateExpire authenticator_state_expire = 3; */
		...
		/* sui.rpc.v2beta.ExecutionTimeObservations execution_time_observations = 4; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.EndOfEpochTransactionKind
 */
...
class AuthenticatorStateExpire$Type extends MessageType<AuthenticatorStateExpire> {
	constructor() {
		super('sui.rpc.v2beta.AuthenticatorStateExpire', [
			{
				no: 1,
				name: 'min_epoch',
				kind: 'scalar',
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.AuthenticatorStateExpire
 */
...
class ExecutionTimeObservations$Type extends MessageType<ExecutionTimeObservations> {
	constructor() {
		super('sui.rpc.v2beta.ExecutionTimeObservations', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional int32 version */ 1:
					message.version = reader.int32();
					break;
				case /* repeated sui.rpc.v2beta.ExecutionTimeObservation observations */ 2:
	...
	internalBinaryWrite(
		...
		/* repeated sui.rpc.v2beta.ExecutionTimeObservation observations = 2; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ExecutionTimeObservations
 */
...
class ExecutionTimeObservation$Type extends MessageType<ExecutionTimeObservation> {
	constructor() {
		super('sui.rpc.v2beta.ExecutionTimeObservation', [
			{
				no: 1,
				name: 'kind',
				kind: 'enum',
				opt: true,
				T: () => [
					'sui.rpc.v2beta.ExecutionTimeObservation.ExecutionTimeObservationKind',
	...
	internalBinaryRead(
		...
		while (reader.pos < end) {
			let [fieldNo, wireType] = reader.tag();
			switch (fieldNo) {
				case /* optional sui.rpc.v2beta.ExecutionTimeObservation.ExecutionTimeObservationKind kind */ 1:
					message.kind = reader.int32();
					break;
				case /* optional sui.rpc.v2beta.MoveCall move_entry_point */ 2:
					...
					break;
				case /* repeated sui.rpc.v2beta.ValidatorExecutionTimeObservation validator_observations */ 3:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.ExecutionTimeObservation.ExecutionTimeObservationKind kind = 1; */
		if (message.kind !== undefined) writer.tag(1, WireType.Varint).int32(message.kind);
		/* optional sui.rpc.v2beta.MoveCall move_entry_point = 2; */
		...
		/* repeated sui.rpc.v2beta.ValidatorExecutionTimeObservation validator_observations = 3; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ExecutionTimeObservation
 */
...
class ValidatorExecutionTimeObservation$Type extends MessageType<ValidatorExecutionTimeObservation> {
	constructor() {
		super('sui.rpc.v2beta.ValidatorExecutionTimeObservation', [
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ValidatorExecutionTimeObservation
 */
