 ...
 *
 * @generated from protobuf message sui.rpc.v2beta.ObjectReference
 */
...
class ObjectReference$Type extends MessageType<ObjectReference> {
	constructor() {
		super('sui.rpc.v2beta.ObjectReference', [
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ObjectReference
 */
