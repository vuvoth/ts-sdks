...
/**
 * @generated from protobuf message sui.rpc.v2beta.ExecutedTransaction
 */
export interface ExecutedTransaction {
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.Transaction transaction = 2;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionEffects effects = 4;
	 */
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.TransactionEvents events = 5;
	 */
	...
	timestamp?: Timestamp;
	/**
	 * @generated from protobuf field: repeated sui.rpc.v2beta.BalanceChange balance_changes = 8;
	 */
	balanceChanges: BalanceChange[];
	/**
	 * Set of input objects used during the execution of this transaction.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Object input_objects = 10;
	 */
	inputObjects: Object[];
	/**
	 * Set of output objects produced from the execution of this transaction.
	 *
	 * @generated from protobuf field: repeated sui.rpc.v2beta.Object output_objects = 11;
	 */
...
class ExecutedTransaction$Type extends MessageType<ExecutedTransaction> {
	constructor() {
		super('sui.rpc.v2beta.ExecutedTransaction', [
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional string digest */ 1:
					...
					break;
				case /* optional sui.rpc.v2beta.Transaction transaction */ 2:
				...
				case /* repeated sui.rpc.v2beta.UserSignature signatures */ 3:
					...
					break;
				case /* optional sui.rpc.v2beta.TransactionEffects effects */ 4:
					...
					break;
				case /* optional sui.rpc.v2beta.TransactionEvents events */ 5:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.Transaction transaction = 2; */
		...
		/* optional sui.rpc.v2beta.TransactionEffects effects = 4; */
		if (message.effects)
		...
		/* optional sui.rpc.v2beta.TransactionEvents events = 5; */
		if (message.events)
		...
		/* repeated sui.rpc.v2beta.BalanceChange balance_changes = 8; */
		...
		/* repeated sui.rpc.v2beta.Object input_objects = 10; */
		...
		/* repeated sui.rpc.v2beta.Object output_objects = 11; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.ExecutedTransaction
 */
