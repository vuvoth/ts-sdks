...
/**
 * @generated from protobuf message sui.rpc.v2beta.Epoch
 */
export interface Epoch {
	 ...
	 *
	 * @generated from protobuf field: optional sui.rpc.v2beta.ValidatorCommittee committee = 2;
	 */
	...
	/**
	 * @generated from protobuf field: optional sui.rpc.v2beta.ProtocolConfig protocol_config = 9;
	 */
...
class Epoch$Type extends MessageType<Epoch> {
		...
		while (reader.pos < end) {
			...
			switch (fieldNo) {
				case /* optional uint64 epoch */ 1:
					...
					break;
				case /* optional sui.rpc.v2beta.ValidatorCommittee committee */ 2:
				...
				case /* optional uint64 reference_gas_price */ 8:
					...
					break;
				case /* optional sui.rpc.v2beta.ProtocolConfig protocol_config */ 9:
	...
	internalBinaryWrite(
		...
		/* optional sui.rpc.v2beta.ValidatorCommittee committee = 2; */
		...
		/* optional sui.rpc.v2beta.ProtocolConfig protocol_config = 9; */
...
/**
 * @generated MessageType for protobuf message sui.rpc.v2beta.Epoch
 */
