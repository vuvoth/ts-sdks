...
class Checkpoint$Type extends MessageType<Checkpoint> {
    constructor() {
        super("sui.rpc.v2.Checkpoint", [
            { no: 1, name: "sequence_number", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            ...
            { no: 6, name: "transactions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ExecutedTransaction },
