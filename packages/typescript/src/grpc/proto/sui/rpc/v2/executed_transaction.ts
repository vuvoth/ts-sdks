...
class ExecutedTransaction$Type extends MessageType<ExecutedTransaction> {
    constructor() {
        super("sui.rpc.v2.ExecutedTransaction", [
            ...
            { no: 6, name: "checkpoint", kind: "scalar", opt: true, T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 7, name: "timestamp", kind: "message", T: () => Timestamp },
            { no: 8, name: "balance_changes", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => BalanceChange },
